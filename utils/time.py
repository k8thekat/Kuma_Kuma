...
class RelativeDelta(app_commands.Transformer, commands.Converter):
    ...
    async def convert(self, ctx: KumaContext, argument: str) -> relativedelta:
        try:
...
class FriendlyTimeResult:
    ...
    async def ensure_constraints(self, ctx: KumaContext, uft: UserFriendlyTime, now: datetime.datetime, remaining: str) -> None:
        if self.dt < now:
            raise commands.BadArgument('This time is in the past.')
...
class UserFriendlyTime(commands.Converter):
    ...
    async def convert(self, ctx: KumaContext, argument: str) -> FriendlyTimeResult:
